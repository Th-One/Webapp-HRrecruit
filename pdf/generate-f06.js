...
async function fillPage1(pdfDoc, page, height, fontRegular, fontBold, data) {
  ...
  put([820, 475, 860, 491], get(current, 'houseNo'), 8, 1);
  put([910, 475, 945, 491], get(current, 'moo'), 8, 1);
  put([990, 475, 1070, 491], get(current, 'village'), 8, 1);
  put([1110, 475, 1158, 491], get(current, 'soi'), 8, 1);
