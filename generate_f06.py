...
def fill_page1(page, data):
    ...
    put(page, (754, 475, 817, 491), get(current, "houseNo"), 8, align=1)
    put(page, (840, 475, 874, 491), get(current, "moo"), 8, align=1)
    put(page, (908, 475, 1014, 491), get(current, "village"), 8, align=0)
    put(page, (1060, 475, 1157, 491), get(current, "soi"), 8, align=0)
